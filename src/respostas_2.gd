...
func _ready():
	...
	$RichTextLabel5.add_text('Se você não quer acabar igual a elas, acho melhor você ir embora para sempre da V.tal!! Agora, se você quiser me desafiar, fique a vontade.. Mas tenho certeza que você não será capaz de responder minhas perguntas!!')
